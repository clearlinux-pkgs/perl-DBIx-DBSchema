...
Version  : 0.47
Release  : 24
URL      : https://cpan.metacpan.org/authors/id/I/IV/IVAN/DBIx-DBSchema-0.47.tar.gz
...
cd %{_builddir}/DBIx-DBSchema-0.47
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/DBIx-DBSchema-0.47/deblicense/
